...
Case3: put(2,20) Adding (key,value) & cache is not filled:
...
Case4: Adding (key,value) & cache is  filled, remvoe the LFU element
...
Case 4 : Update the existing (key,value) Pair
	    	Flow is same as  
	    	Case2 : Accessing valid Key & Updating the LFUCounter.
